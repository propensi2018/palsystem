...
//return [$kumpulanTemp];
return view('profile-prospect',  compact('prospect','prospectNotes','customerData','pw','prospectAddress','customerType','customerSchedule','productList','productListAssoc','productType','prospectTypeProdukDesc','productListAmount','kumpulanTemp','addressProspect','scheduleAppointmentId','scheduleDeal','joinSchedule','today','scheduleSkrg','allSchedule'));
//  return compact('scheduleAppointmentId');
